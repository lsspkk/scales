...
| `hiddenNotes` | `ReadonlyArray<string>?` | Optional pitch-class strings (e.g. `["F#", "B"]`) to draw at 10% opacity in both the scale and arpeggio canvases. Used by the Harjoittelu hidden-note challenge (Task 26). |
