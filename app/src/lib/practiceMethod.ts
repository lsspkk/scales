...
export const SCALES: ScaleEntry[] = [
  ...
  { key: 'G',  mode: 'ionian',  level: 2, positions: ['1st', '3rd'], octaves: 2, shiftPattern: 'Siirto ylös B:llä (2. sormi, A-kieli)',  arpeggio: 'major', arpeggioOctaves: 2 },
  { key: 'D',  mode: 'ionian',  level: 2, positions: ['1st', '3rd'], octaves: 2, shiftPattern: 'Siirto ylös F#:lla (2. sormi, E-kieli)', arpeggio: 'major', arpeggioOctaves: 2 },
  { key: 'A',  mode: 'ionian',  level: 2, positions: ['1st', '3rd'], octaves: 2, shiftPattern: 'Siirto ylös C#:lla (2. sormi, A-kieli)', arpeggio: 'major', arpeggioOctaves: 2 },
  { key: 'E',  mode: 'ionian',  level: 2, positions: ['1st', '3rd'], octaves: 2, shiftPattern: 'Siirto ylös G#:lla (2. sormi, E-kieli)', arpeggio: 'major', arpeggioOctaves: 2 },
  { key: 'F',  mode: 'ionian',  level: 2, positions: ['1st', '3rd'], octaves: 2, shiftPattern: 'Siirto ylös A:lla (1. sormi, E-kieli)',  arpeggio: 'major', arpeggioOctaves: 2 },
  { key: 'Bb', mode: 'ionian',  level: 2, positions: ['1st', '3rd'], octaves: 2, shiftPattern: 'Siirto ylös D:llä (1. sormi, A-kieli)',  arpeggio: 'major', arpeggioOctaves: 2 },
  { key: 'Eb', mode: 'ionian',  level: 2, positions: ['1st', '3rd'], octaves: 2, shiftPattern: 'Siirto ylös G:llä (1. sormi, D-kieli)',  arpeggio: 'major', arpeggioOctaves: 2 },
  { key: 'E',  mode: 'aeolian', level: 2, positions: ['1st', '3rd'], octaves: 2, shiftPattern: 'Siirto ylös G:llä (2. sormi, E-kieli)',  arpeggio: 'minor', arpeggioOctaves: 2 },
  { key: 'B',  mode: 'aeolian', level: 2, positions: ['1st', '3rd'], octaves: 2, shiftPattern: 'Siirto ylös D:llä (1. sormi, A-kieli)',  arpeggio: 'minor', arpeggioOctaves: 2 },
  { key: 'D',  mode: 'aeolian', level: 2, positions: ['1st', '3rd'], octaves: 2, shiftPattern: 'Siirto ylös F:llä (1. sormi, E-kieli)',  arpeggio: 'minor', arpeggioOctaves: 2 },
  { key: 'G',  mode: 'aeolian', level: 2, positions: ['1st', '3rd'], octaves: 2, shiftPattern: 'Siirto ylös Bb:llä (1. sormi, A-kieli)', arpeggio: 'minor', arpeggioOctaves: 2 },
  { key: 'C',  mode: 'aeolian', level: 2, positions: ['1st', '3rd'], octaves: 2, shiftPattern: 'Siirto ylös Eb:llä (1. sormi, D-kieli)', arpeggio: 'minor', arpeggioOctaves: 2 },

  // ── Level 3 — Three Positions with Intermediate Shifts ──
  { key: 'G',  mode: 'ionian',  level: 3, positions: ['1st', '2nd', '3rd'], octaves: 2, shiftPattern: '1.→2. A-kielellä, 2.→3. E-kielellä', arpeggio: 'major', arpeggioOctaves: 2 },
  { key: 'D',  mode: 'ionian',  level: 3, positions: ['1st', '2nd', '3rd'], octaves: 2, shiftPattern: '1.→2. A-kielellä, 2.→3. E-kielellä', arpeggio: 'major', arpeggioOctaves: 2 },
  { key: 'A',  mode: 'ionian',  level: 3, positions: ['1st', '2nd', '3rd'], octaves: 2, shiftPattern: '1.→2. D-kielellä, 2.→3. A-kielellä', arpeggio: 'major', arpeggioOctaves: 2 },
  { key: 'E',  mode: 'ionian',  level: 3, positions: ['1st', '2nd', '3rd'], octaves: 2, shiftPattern: '1.→2. A-kielellä, 2.→3. E-kielellä', arpeggio: 'major', arpeggioOctaves: 2 },
  { key: 'B',  mode: 'ionian',  level: 3, positions: ['1st', '2nd', '3rd'], octaves: 2, shiftPattern: '1.→2. E-kielellä, 2.→3. E-kielellä', arpeggio: 'major', arpeggioOctaves: 2 },
  { key: 'F',  mode: 'ionian',  level: 3, positions: ['1st', '2nd', '3rd'], octaves: 2, shiftPattern: '1.→2. D-kielellä, 2.→3. A-kielellä', arpeggio: 'major', arpeggioOctaves: 2 },
  { key: 'Bb', mode: 'ionian',  level: 3, positions: ['1st', '2nd', '3rd'], octaves: 2, shiftPattern: '1.→2. G-kielellä, 2.→3. D-kielellä', arpeggio: 'major', arpeggioOctaves: 2 },
  { key: 'Eb', mode: 'ionian',  level: 3, positions: ['1st', '2nd', '3rd'], octaves: 2, shiftPattern: '1.→2. G-kielellä, 2.→3. D-kielellä', arpeggio: 'major', arpeggioOctaves: 2 },
  { key: 'Ab', mode: 'ionian',  level: 3, positions: ['1st', '2nd', '3rd'], octaves: 2, shiftPattern: '1.→2. D-kielellä, 2.→3. A-kielellä', arpeggio: 'major', arpeggioOctaves: 2 },
  { key: 'E',  mode: 'aeolian', level: 3, positions: ['1st', '2nd', '3rd'], octaves: 2, shiftPattern: '1.→2. A-kielellä, 2.→3. E-kielellä', arpeggio: 'minor', arpeggioOctaves: 2 },
  { key: 'B',  mode: 'aeolian', level: 3, positions: ['1st', '2nd', '3rd'], octaves: 2, shiftPattern: '1.→2. E-kielellä, 2.→3. E-kielellä', arpeggio: 'minor', arpeggioOctaves: 2 },
  { key: 'F#', mode: 'aeolian', level: 3, positions: ['1st', '2nd', '3rd'], octaves: 2, shiftPattern: '1.→2. A-kielellä, 2.→3. E-kielellä', arpeggio: 'minor', arpeggioOctaves: 2 },
  { key: 'C',  mode: 'aeolian', level: 3, positions: ['1st', '2nd', '3rd'], octaves: 2, shiftPattern: '1.→2. G-kielellä, 2.→3. D-kielellä', arpeggio: 'minor', arpeggioOctaves: 2 },
  { key: 'D',  mode: 'aeolian', level: 3, positions: ['1st', '2nd', '3rd'], octaves: 2, shiftPattern: '1.→2. D-kielellä, 2.→3. A-kielellä', arpeggio: 'minor', arpeggioOctaves: 2 },
]
