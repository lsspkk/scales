...
/** Single ascending octave for root/mode (8 entries; last = the octave repeat of the
 *  root), mirroring Tähtiasteikko so socket count = note count and the turn is the top. */
export function getScaleNotes(root: string, mode: string): NoteWithOctave[] {
