  ...
  return (
    <div className="space-y-5">
      ...
      <section>
        ...
        <p className="text-base font-mono bg-[#f5e9cc] rounded-lg px-3 py-2 text-[#3a1a00]">
          {detail.notes.join(' – ')}
        </p>
      ...
      <section>
        ...
        <p className="text-base font-mono bg-[#f5e9cc] rounded-lg px-3 py-2 text-[#3a1a00] mb-1">
          {detail.arpeggioNotes}
        </p>
